...
module GolfGenius
  ...
  class Scoreboard
    ...
    #
    def initialize(event:, round: nil, tournament: nil)
    ...
    def build_schema
      ...
      round = fetch_round_metadata(event)
    ...
    #
    # Fetches the event and calls latest_round to get the latest round by index/date.
    #
    ...
    def resolve_round!
      ...
      raise StandardError, "No rounds found for event #{@event_id}" if latest.nil?
